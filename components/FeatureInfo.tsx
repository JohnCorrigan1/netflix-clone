    ...
    return (
        <div className=" z-50 absolute text-white top-60 left-28 info flex flex-col gap-16">
            ...
            <div className="flex gap-5 w-full justify-center text-zinc-900">
                ...
                Play</button>
                <button className="pr-8 pl-8 p-2 bg-zinc-400 text-2xl hover:bg-zinc-600 rounded-sm bg-opacity-20 flex justify-center items-center gap-2 text-zinc-100 font-semibold">
