  ...
  return (
    <>
      ...
      <div className="bg-zinc-900 text-zinc-200 flex flex-col items-center rounded-xl fixed top-1/2 left-1/2 -translate-x-1/2 justify-center -translate-y-1/2 w-1/2 max-w-xl overflow-y-scroll scrollbar-hide h-2/6 z-[2001]">
        <div
          className="hover:bg-zinc-600 hover:scale-105 rounded-full bg-opacity-50 active:scale-95 absolute top-3 right-3"
          onClick={closeHandler}
        >
        ...
        <form onSubmit={submitHandler}>
          <div className="flex flex-col gap-5">
            ...
            <input
              ...
              name="username"
              id="username"
              className="bg-zinc-800 text-zinc-200 rounded-lg p-2"
              onChange={usernameHandler}
            />
          </div>
          <button
            className="bg-main font-bold hover:scale-105 active:scale-95 rounded-lg p-2 mt-5 w-full"
            type="submit"
          >
            Create Profile
          </button>
